...
import { Orbit, AlertTriangle, Shield, Gauge, Ruler, Calendar, ArrowRight } from "lucide-react";
...
function AsteroidCard({ asteroid }: { asteroid: Asteroid }) {
  return (
    <Link href={`/asteroids/${asteroid.id}`}>
      <Card
        className={`overflow-hidden transition-all hover:border-white/20 hover:bg-white/5 cursor-pointer h-full ${
